...
Тут всё подряд под итерацией, так что инварианты с подсчётом количества букв отпадают. Если встретили `abab`, то дальше идёт либо `b` либо `abb` (часть регулярки $(ab\*a) \dots (babb)\*$)

<img src="afa.png" width="1001"  alt="afa png here"/>
